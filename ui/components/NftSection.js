...
export const NftSection = () => {
  ...
  const changeAllNfts = async () => {
    ...
    console.log("!!!!sendMyTokens", sendMyTokens)
    ...
    console.log("!!!!sendExchangeTokens", sendExchangeTokens)
    ...
    setTransferringStatus("Transferring is completed. Fetching updated nfts...")
  ...
  return (
    <div className="flex flex-col border-4  border-solid border-red">
      <div className="flex flex-col items-center border-4  border-solid border-blue-500">
        <div>
          <h2>My Principal:</h2>
        </div>
        <div>{auth.principal?.toText()}</div>
        <div>
          <button onClick={login}>Login to II</button>
        </div>
      </div>
      <div className="flex flex-col items-center border-4 border-solid border-blue-500">
        {/* <div className=""> */}
        ...
        <div>
          ...
          {myNfts.nfts.length > 0 && (
            <div className="container border-4 border-solid border-red-500 max-w-2xl">
      ...
      <div className="flex flex-col items-center border-4 border-solid border-blue-500">
        ...
        <div>
          <label htmlFor="name">Enter exchange user principal: &nbsp;</label>
          <input
            id="principal"
            alt="Principal"
            type="text"
        ...
        <div className="mt-4">
          <button onClick={showExchangeNfts}>Show Exchange NFTs</button>
        </div>
        <div>
          {/* <label>Response: &nbsp;</label> */}
      ...
      <div className="flex flex-col items-center border-4 border-solid border-blue-500">
        <div>
          <h2>Change all my NFTs to all the exchange NFTs</h2>
        </div>

        <div className="mt-4">
          <button onClick={changeAllNfts}>Make a change</button>
        </div>

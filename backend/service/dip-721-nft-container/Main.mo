...
// !!!! Not safe implementation, the autorisation checks are removed. For only dev!!!
        ...
        // TODO below is the original code
        // if (
  ...
  public shared({ caller }) func mintDip721(to: Principal, metadata: Types.MetadataDesc) : async Types.MintReceipt {
    // !!!!!! The authorisation check is commented. For development only!!!!
